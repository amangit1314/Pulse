...
import { createEventSchema, updateEventSchema, searchEventsSchema, } from './events.validation.js';
const router = Router();
...
router.put('/:eventId', authenticate, authorize('ORGANIZER', 'ADMIN'), validate(updateEventSchema), eventsController.updateEvent.bind(eventsController));
router.delete('/:eventId', authenticate, authorize('ORGANIZER', 'ADMIN'), eventsController.deleteEvent.bind(eventsController));
