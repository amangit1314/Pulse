...
router.post(
    ...
    organizationsController.addTeamMember.bind(organizationsController)
);

router.delete(
    '/:orgId/team/:userId',
    authorize('ORGANIZER', 'ADMIN'),
    organizationsController.removeTeamMember.bind(organizationsController)
);

router.put(
    '/:orgId/team/:userId/role',
    authorize('ORGANIZER', 'ADMIN'),
    organizationsController.updateTeamMemberRole.bind(organizationsController)
);
...
router.put(
    ...
    organizationsController.updateSubscription.bind(organizationsController)
);
...
router.get(
    '/:orgId/analytics',
    authorize('ORGANIZER', 'ADMIN'),
    organizationsController.getAnalytics.bind(organizationsController)
);
