...
router.put(
    ...
    usersController.markNotificationAsRead.bind(usersController)
);
router.put(
    '/notifications/read-all',
    usersController.markAllNotificationsAsRead.bind(usersController)
);
...
router.delete(
    '/wishlist/:eventId',
    usersController.removeFromWishlist.bind(usersController)
);
